...
void tampil(void) {
	...
	glVertex3f(440, 0, 130);
	glVertex3f(440, 0, -200);
	...
	glBegin(GL_POLYGON);
	glColor3f(0.671f, 0.322f, 0.0f);
	glVertex3f(-129, 20, -10);
	glVertex3f(-129, 0.1, -10);
	glVertex3f(-129, 0.1, -25);
	glVertex3f(-129, 20, -25);
	glEnd();

	glBegin(GL_POLYGON);
	glColor3f(0.671f, 0.322f, 0.0f);
	glVertex3f(-124, 20, -10);
	glVertex3f(-124, 0.1, -10);
	glVertex3f(-124, 0.1, -25);
	glVertex3f(-124, 20, -25);
	glEnd();
	...
	glBegin(GL_LINE_LOOP);
	glColor3f(0, 0, 0);
	glVertex3f(-123.9, 0.1, -17.5);
	glVertex3f(-123.9, 20, -17.5);
	glEnd();
	...
	glColor3f(1, 1, 1);
	glVertex3f(-90, 5, -10);
	glVertex3f(-90, 0.1, -10);
	glVertex3f(-90, 0.1, -25);
	glVertex3f(-90, 5, -25);
	glEnd();
	...
	glVertex3f(-90, 0.1, -10);
	glVertex3f(-90, 0.1, -25);
	glVertex3f(-60, 0.1, -25);
	glVertex3f(-60, 0.1, -10);
	glEnd();
	...
	glVertex3f(-95, 0, 20);
	glVertex3f(-93, 0, 20);
	glVertex3f(-93, 9.9, 20);
	glVertex3f(-95, 9.9, 20);
	glEnd();
	...
	glVertex3f(-95, 0, 22);
	glVertex3f(-93, 0, 22);
	glVertex3f(-93, 9.9, 22);
	glVertex3f(-95, 9.9, 22);
	glEnd();
	...
	glVertex3f(-75, 0, 20);
	glVertex3f(-77, 0, 20);
	glVertex3f(-77, 9.9, 20);
	glVertex3f(-75, 9.9, 20);
	glEnd();
	...
	glVertex3f(-75, 0, 22);
	glVertex3f(-77, 0, 22);
	glVertex3f(-77, 9.9, 22);
	glVertex3f(-75, 9.9, 22);
	glEnd();
	...
	glVertex3f(-95, 0, 38);
	glVertex3f(-93, 0, 38);
	glVertex3f(-93, 9.9, 38);
	glVertex3f(-95, 9.9, 38);
	glEnd();
	...
	glVertex3f(-95, 0, 40);
	glVertex3f(-93, 0, 40);
	glVertex3f(-93, 9.9, 40);
	glVertex3f(-95, 9.9, 40);
	glEnd();
	...
	glVertex3f(-75, 0, 38);
	glVertex3f(-77, 0, 38);
	glVertex3f(-77, 9.9, 38);
	glVertex3f(-75, 9.9, 38);
	glEnd();
	...
	glVertex3f(-75, 0, 40);
	glVertex3f(-77, 0, 40);
	glVertex3f(-77, 9.9, 40);
	glVertex3f(-75, 9.9, 40);
	glEnd();
	...
	glBegin(GL_POLYGON);
	glColor4f(1.0f, 1.0f, 0.9f, 0.0f);
	glVertex3f(-129, 30, -50);
	glVertex3f(-129, 50, -50);
	...
	glBegin(GL_POLYGON);
	glColor4f(1.0f, 1.0f, 0.9f, 0.0f);
	glVertex3f(161, 30, -50);
	glVertex3f(161, 50, -50);
	...
	glVertex3f(407, 50, -50);
	glVertex3f(407, 30, -50);
	glEnd();
	//bangun l1 end
	...
	glBegin(GL_QUADS);
	glColor4f(0.8f, 0.8f, 0.8f, 0.8f);
	glVertex3f(160, 0, 130);
	glVertex3f(160, 0, 150);
	glVertex3f(215, 0, 150);
	glVertex3f(215, 0, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(160, 0, 130);
	glVertex3f(160, 0, 150);
	glVertex3f(160, 5, 150);
	glVertex3f(160, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(165, 0, 130);
	glVertex3f(165, 0, 150);
	glVertex3f(165, 5, 150);
	glVertex3f(165, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(160, 5, 150);
	...
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(210, 0, 130);
	glVertex3f(210, 0, 150);
	glVertex3f(210, 5, 150);
	glVertex3f(210, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(215, 0, 130);
	glVertex3f(215, 0, 150);
	glVertex3f(215, 5, 150);
	glVertex3f(215, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(210, 5, 150);
	...
	glBegin(GL_QUADS);
	glColor4f(0.8f, 0.8f, 0.8f, 0.8f);
	glVertex3f(260, 0, 130);
	glVertex3f(260, 0, 150);
	glVertex3f(325, 0, 150);
	glVertex3f(325, 0, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(260, 0, 130);
	glVertex3f(260, 0, 150);
	glVertex3f(260, 5, 150);
	glVertex3f(260, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(265, 0, 130);
	glVertex3f(265, 0, 150);
	glVertex3f(265, 5, 150);
	glVertex3f(265, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(260, 5, 150);
	...
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(320, 0, 130);
	glVertex3f(320, 0, 150);
	glVertex3f(320, 5, 150);
	glVertex3f(320, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(325, 0, 130);
	glVertex3f(325, 0, 150);
	glVertex3f(325, 5, 150);
	glVertex3f(325, 5, 130);
	glEnd();
	glBegin(GL_QUADS);
	glColor4f(0, 0, 0, 0);
	glVertex3f(320, 5, 150);
	...
	glBegin(GL_QUADS);
	glColor3f(0, 0, 0);
	glVertex3f(-200, -30, -200);
	glVertex3f(-200, -30, 130);
	glVertex3f(-200, 0, 130);
	glVertex3f(-200, 0, -200);
	glEnd();
	glBegin(GL_QUADS);
	...
	glVertex3f(-160, 0, 260);
	glVertex3f(-120, 0, 260);
	glVertex3f(-110, -30, 150);
	glVertex3f(-160, -30, 150);
	glEnd();
	glBegin(GL_QUADS);
	glColor3f(0.345f, 0.333f, 0.333f);
	glVertex3f(-160, -30, 50);
	...
	glBegin(GL_QUADS);
	glColor3f(0, 0, 0);
	glVertex3f(-110, -30, 110);
	glVertex3f(400, -30, 110);
	glVertex3f(400, 0, 110);
	...
	glBegin(GL_QUADS);
	glColor3f(1, 1, 0);
	glVertex3f(-200, 0, 110);
	glVertex3f(-200, 0, 260);
	glVertex3f(-160, 0, 260);
	glVertex3f(-160, 0, 110);
	glEnd();
	glBegin(GL_QUADS);
	glColor3f(0, 0, 0);
	glVertex3f(-160, -30, 150);
	...
	glVertex3f(-120, -30, 150);
	glEnd();
	glBegin(GL_QUADS);
	glColor3f(0.345f, 0.333f, 0.333f);
	glVertex3f(-120, -30, 150);
	glVertex3f(400, -30, 150);
	glVertex3f(400, -30, 110);
	glVertex3f(-120, -30, 110);
	glEnd();
	glBegin(GL_QUADS);
	...
	glBegin(GL_QUADS);
	glColor4f(0.8f, 0.8f, 0.8f, 0.8f);
	glVertex3f(-135, 0, 300);
	glVertex3f(440, 0, 300);
	glVertex3f(440, 0, 150);
	glVertex3f(-80, 0, 150);
	glEnd();
	//taman
	glBegin(GL_QUADS);
	glColor3f(0, 1, 0);
	glVertex3f(-100, 0.5, 280);
	glVertex3f(80, 0.5, 280);
	glVertex3f(0, 0.5, 180);
	glVertex3f(-60, 0.5, 180);
	glEnd();
	glBegin(GL_TRIANGLES);
	glColor3f(0, 1, 0);
	glVertex3f(20, 0.5, 180);
	glVertex3f(120, 0.5, 290);
	glVertex3f(160, 0.5, 180);
	glEnd();
	glBegin(GL_QUADS);
	glColor3f(0, 1, 0);
	glVertex3f(210, 0.5, 180);
	glVertex3f(160, 0.5, 280);
	glVertex3f(340, 0.5, 280);
	glVertex3f(260, 0.5, 180);
	glEnd();
	glBegin(GL_TRIANGLES);
	glColor3f(0, 1, 0);
	glVertex3f(320, 0.5, 180);
	glVertex3f(380, 0.5, 290);
	glVertex3f(420, 0.5, 180);
	glEnd();
	//taman kelar
